...
public class KakaoLoginApi {
	...
	private final static String K_CLIENT_ID = "c6208a531345694a68002c5cd7af8783"; 
	// 카카오 개발자 페이지에서  로그인 Redirect URI 에 설정한 값 
	private final static String K_REDIRECT_URI = "http://localhost:8084/testtwo/kakaologinok";
